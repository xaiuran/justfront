...
@Component({
  selector: 'app-b310058',
  templateUrl: './b310058.component.html',
  styleUrls: ['./b310058.component.css']
})


export class b310058Component {
  title = 'Interface';
  gosts: any[];
  gost: any;
  TypeGosts: any[];
  searchStr='тип 3';
  b310058:string="GOST_TYPES_10058";
  ...
  async getGosts(){
    try{
      let gosts = this.gostsService.getAllGosts(this.b310058)
