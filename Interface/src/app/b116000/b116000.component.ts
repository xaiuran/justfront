...
@Component({
  selector: 'app-b116000',
  templateUrl: './b116000.component.html',
  styleUrls: ['./b116000.component.css']
})
export class b116000Component {
  title = 'Interface';
  gosts: any[];
  gost: any;
  TypeGosts: any[];
  searchStr='116000';
  b116000:string="GOST_TYPES_8995";
  ...
  async getGosts(){
    try{
      let gosts = this.gostsService.getAllGosts(this.b116000)
