...
import { GostsService } from '../b8882/services/gosts.service';

@Component({
  selector: 'app-b8882',
  templateUrl: './b8882.component.html',
  styleUrls: ['./b8882.component.css']
})

export class b8882Component {
  title = 'Interface';
  gosts: any[];
  gost: any;
  TypeGosts: any[];
  u:string="GOST_TYPES_8882";
  ...
  async getGosts(){
    try{
      let gosts = this.gostsService.getAllGosts(this.u)
