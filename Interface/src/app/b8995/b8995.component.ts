...
import { GostsService } from '../b8995/services/gosts.service';

@Component({
  selector: 'app-b8995',
  templateUrl: './b8995.component.html',
  styleUrls: ['./b8995.component.css']
})

export class b8995Component {
  title = 'Interface';
  gosts: any[];
  gost: any;
  TypeGosts: any[];
  b8995:string="GOST_TYPES_8885";
  ...
  async getGosts(){
    try{
      let gosts = this.gostsService.getAllGosts(this.b8995)
